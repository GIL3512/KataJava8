...
public class Exercise5Test extends ClassicOnlineStore {
    ...
    public void nameInCsv() {
         ...
         */
        String string = "["+ customerList.stream().map(cus -> cus.getName()).collect(Collectors.joining(","))+"]";
    ...
    public void oldestCustomer() {
         ...
         */
        Optional<Customer> oldestCustomer = customerList.stream().collect(Collectors.maxBy(Comparator.comparing(customer -> customer.getAge())));
