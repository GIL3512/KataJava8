...
public class Exercise2Test extends ClassicOnlineStore {
    ...
    public void sortByAge() {
         ...
         */
        Stream<Integer> sortedAgeStream = customerList.stream().sorted(Comparator.comparing(Customer::getAge))
                .map(a->a.getAge());
    ...
    public void distinctAge() {
         ...
         */
        Stream<Integer> distinctAgeStream = customerList.stream().map(cus->cus.getAge()).distinct();
